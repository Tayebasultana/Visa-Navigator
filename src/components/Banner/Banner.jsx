        ...
        <div className="slider">
            <div className="image-container h-[300px] md:h-[400px] lg:h-[600px] w-full">
                ...
                <div className="slide-overlay">
                    <h2 className={`font-bold ${slides[currentIndex].isBig ? "text-5xl pt-4 md:pt-24 pb-4" : "text-3xl"}`}>{slides[currentIndex].title}</h2>
                    <p className={`${slides[currentIndex].isBig ? " pb-4" : ""}`}>{slides[currentIndex].description}</p>

                   
                    {slides[currentIndex].buttonText === "All visas" ? (
                        <Link to={slides[currentIndex].link}>
                            <button className="slider-button bg-black hover:bg-emerald-700">
